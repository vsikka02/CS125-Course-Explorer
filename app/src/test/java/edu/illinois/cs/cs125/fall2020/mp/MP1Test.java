...
public final class MP1Test {
  ...
  public static void setup() throws IOException {
    ...
    // Load summaries JSON
    String summaryJson =
        new Scanner(MP1Test.class.getResourceAsStream("/2020_fall_summary.json"), "UTF-8")
            .useDelimiter("\\A")
            .next();
    ...
    // Load courses JSON
    String coursesJson =
        new Scanner(MP1Test.class.getResourceAsStream("/2020_fall.json"), "UTF-8")
            .useDelimiter("\\A")
            .next();
  ...
  public static class UnitTests {
    ...
    public void testServerCourseRoute() throws IOException {
      ...
      request =
          new Request.Builder()
              .url(CourseableApplication.SERVER_URL + "course/2020/fall/CS/88/")
              .build();
      ...
      request =
          new Request.Builder()
              .url(CourseableApplication.SERVER_URL + "courses/2020/fall/CS/125/")
              .build();
      response = client.newCall(request).execute();
      assertThat(response.code()).isEqualTo(HttpStatus.SC_NOT_FOUND);
    }
